...
public class MixinChunkRendererRegion implements IPatchedChunkRendererRegion {
    ...
    private final BlockPos.Mutable mutablePos1 = new BlockPos.Mutable();
    ...
    public BlockModelRenderer.AmbientOcclusionCalculator getAmbientOcclusionCalculator(@NotNull BlockModelRenderer renderer) {
        if (aoCalculator == null) {
            aoCalculator = new BlockModelRenderer.AmbientOcclusionCalculator();
        }
        return aoCalculator;
    }
    ...
    @NotNull
    @Override
    public BlockPos.Mutable getMutablePos1() {
        return mutablePos1;
    }
}
